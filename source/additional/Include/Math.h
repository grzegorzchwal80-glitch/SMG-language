...
__declspec(dllexport) double mulD(double a, double b){return a * b;}
__declspec(dllexport) long long mulLL(long long a, long long b){return a * b;}
__declspec(dllexport) long long divLL(long long a, long long b){return a / b;}
__declspec(dllexport) double divD(double a, double b){return a / b;}